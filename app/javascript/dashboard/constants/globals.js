export default {
  ...
  DOCS_URL: 'https://www.vartana.ia.br/docs/product/',
  HELP_CENTER_DOCS_URL:
    'https://www.vartana.ia.br/docs/product/others/help-center',
  TESTIMONIAL_URL:
    'https://testimonials.cdn.vartana.ia.br/testimonial-content.json',
