...
describe('#mutations', () => {
  describe('#SET_CONTACTS', () => {
    it('set contact records', () => {
      ...
      mutations[types.SET_CONTACTS](state, [
        { id: 2, name: 'contact2', email: 'contact2@vartana.ia.br' },
        { id: 1, name: 'contact1', email: 'contact1@vartana.ia.br' },
      ]);
      expect(state.records).toEqual({
        1: {
          id: 1,
          name: 'contact1',
          email: 'contact1@vartana.ia.br',
        },
        2: {
          id: 2,
          name: 'contact2',
          email: 'contact2@vartana.ia.br',
        },
      });
  ...
  describe('#SET_CONTACT_ITEM', () => {
    it('push contact data to the store', () => {
      const state = {
        records: {
          1: { id: 1, name: 'contact1', email: 'contact1@vartana.ia.br' },
        },
        sortOrder: [1],
      };
      ...
      expect(state.records).toEqual({
        1: { id: 1, name: 'contact1', email: 'contact1@vartana.ia.br' },
        2: { id: 2, name: 'contact2', email: 'contact2@vartana.ia.br' },
      });
  ...
  describe('#EDIT_CONTACT', () => {
    it('update contact', () => {
      ...
      expect(state.records).toEqual({
        1: { id: 1, name: 'contact2', email: 'contact2@vartana.ia.br' },
      });
    });
  });
