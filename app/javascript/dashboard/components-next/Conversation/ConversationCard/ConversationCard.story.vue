...
const conversationWithoutMeta = {
  ...
  messages: [
    {
      ...
      conversation: {
        ...
        contactInbox: {
          sourceId: 'candice@vartana.ia.br',
        },
      },
    },
  ],
  ...
  lastNonActivityMessage: {
    ...
    conversation: {
      ...
      contact_inbox: {
        source_id: 'candice@vartana.ia.br',
      },
    },
    sender: {
      id: 1,
