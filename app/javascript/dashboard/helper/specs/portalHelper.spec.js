...
describe('PortalHelper', () => {
  describe('buildPortalURL', () => {
    it('returns the correct url', () => {
      window.chatwootConfig = {
        hostURL: 'https://app.vartana.ia.br',
        helpCenterURL: 'https://help.vartana.ia.br',
      };
      expect(buildPortalURL('handbook')).toEqual(
        'https://help.vartana.ia.br/hc/handbook'
      );
      window.chatwootConfig = {};
    });
  });
  ...
  describe('buildPortalArticleURL', () => {
    it('returns the correct url', () => {
      ...
      ).toEqual('https://help.vartana.ia.br/hc/handbook/articles/article-slug');
      window.chatwootConfig = {};
    });
    ...
    it('uses hostURL when helpCenterURL is not available', () => {
      ...
      expect(
        buildPortalArticleURL('handbook', 'culture', 'fr', 'article-slug')
      ).toEqual('https://app.vartana.ia.br/hc/handbook/articles/article-slug');
    });
  });
