...
CHATWOOT_HUB_URL="https://hub.2.vartana.ia.br/events"
...
Join the community at https://vartana.ia.br/community?utm_source=cwctl
***************************************************************************
...
function get_cw_version() {
  CW_VERSION=$(curl -s https://app.vartana.ia.br/api | python3 -c 'import sys,json;data=json.loads(sys.stdin.read()); print(data["version"])')
}
...
https://www.vartana.ia.br/docs/deployment/deploy-chatwoot-in-linux-vm?utm_source=cwctl
...
Get help, https://vartana.ia.br/community?utm_source=cwctl
