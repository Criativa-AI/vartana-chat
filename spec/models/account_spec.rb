...
RSpec.describe Account do
  ...
  describe 'support_email' do
    ...
    it 'returns the support email from inbox if inbox value is present' do
      account.update(support_email: 'support@vartana.ia.br')
      with_modified_env MAILER_SENDER_EMAIL: 'hello@vartana.ia.br' do
        expect(account.support_email).to eq('support@vartana.ia.br')
      end
    end
    ...
    it 'returns the support email from ENV if inbox value is nil' do
      ...
      with_modified_env MAILER_SENDER_EMAIL: 'hello@vartana.ia.br' do
        expect(account.support_email).to eq('hello@vartana.ia.br')
      end
    end
