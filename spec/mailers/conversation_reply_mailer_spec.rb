...
RSpec.describe ConversationReplyMailer do
  describe 'reply' do
      ...
      context 'when message is a CSAT survey' do
        ...
        it 'includes CSAT survey URL in outgoing_content' do
          with_modified_env 'FRONTEND_URL' => 'https://app.vartana.ia.br' do
            ...
            expect(mail.decoded).to include "https://app.vartana.ia.br/survey/responses/#{conversation.uuid}"
          end
        end
    ...
    context 'when inbox email address is available' do
      let(:inbox) { create(:inbox, account: account, email_address: 'noreply@vartana.ia.br') }
